...
public class JavaOperatorApi {
	...
	public static double FAdd(double x, double y) {
		return x + y;
	}

	public static double FSub(double x, double y) {
		return x - y;
	}

	public static double FMul(double x, double y) {
		return x * y;
	}

	public static double FDiv(double x, double y) {
		return x / y;
	}
